...
export { MetamaskSafientSnap } from "./snap";
export {
  hasMetaMask,
  isMetamaskSnapsSupported,
  isSnapInstalled,
 ...
 * @param snapOrigin
 *
 * @return MetamaskSafientSnap - adapter object that exposes snap API
 */
export async function enableFilecoinSnap(
  ...
  const snap = new MetamaskSafientSnap(snapOrigin || defaultSnapOrigin);
